  ...
  <section id="projetos" class="sessao-projetos">
    <div class="container-projetos">
      ...
      <div class="grid-projetos">
        <div v-for="(projeto, index) in listaProjetos" 
             :key="index" 
             class="card-projeto revelar"
...
/* --- Cabeçalho --- */
.cabecalho-projetos { text-align: center; margin-bottom: 60px; }
.subtitulo { color: #00cdfb; letter-spacing: 4px; font-size: 0.9rem; text-transform: uppercase; margin-bottom: 10px; }
.titulo-sessao { font-size: 3rem; font-weight: 900; }
.linha-decorativa { width: 80px; height: 4px; background: #00cdfb; margin: 20px auto; }
...
.card-projeto:hover .overlay-card { opacity: 1; }

.links-projeto { display: flex; gap: 20px; }
.links-projeto a {
...
.links-projeto a:hover { transform: scale(1.2); background: white; color: #00cdfb; }

.info-projeto { padding: 25px; }
.info-projeto h3 { margin-bottom: 10px; font-size: 1.4rem; }
.info-projeto p { color: #aaa; font-size: 0.95rem; line-height: 1.6; margin-bottom: 20px; }
